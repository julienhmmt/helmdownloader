...
func TestRetag(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			prefix: "rgy01.domain.tdmc",
			want:   "rgy01.domain.tdmc/quay.io/argoproj/argocd:v3.2.6",
		},
		{
			name:   "docker hub official shorthand",
			ref:    "redis:8.2.2-alpine",
			prefix: "rgy01.domain.tdmc",
			want:   "rgy01.domain.tdmc/docker.io/library/redis:8.2.2-alpine",
		},
		{
			name:   "docker hub namespaced shorthand",
			ref:    "mattermost/mattermost-team-edition:10.9.1",
			prefix: "rgy01.domain.tdmc",
			want:   "rgy01.domain.tdmc/docker.io/mattermost/mattermost-team-edition:10.9.1",
		},
		{
			name:   "digest reference",
			ref:    "ghcr.io/dexidp/dex@sha256:abcdef",
			prefix: "rgy01.domain.tdmc",
			want:   "rgy01.domain.tdmc/ghcr.io/dexidp/dex@sha256:abcdef",
		},
		{
